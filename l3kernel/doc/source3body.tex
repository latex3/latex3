...
\subsection{Behavior of \texttt{c}-type expansion where \texttt{N}-type token
...
only applied where resulting \texttt{N}-type token will definitely exist,
i.e.~is either defined prior to the application of the \texttt{c}-type
