...
\begin{description}
  ...
  \item[\texttt{e}] The \texttt{e} specifier is in many respects
    ...
    expandable.
  \item[\texttt{f}] The \texttt{f} specifier stands for \emph{expansion
    until the \textbf{f}irst non-expandable token}, and in contrast to
    \texttt{e}/\texttt{x} stops at the first
