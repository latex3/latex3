...
%
%% File: source3body.tex Copyright (C) 1990-2011 by The LaTeX3 Project
%%
...
\begin{description}
  ...
  \item[\texttt{seq}] \eqnuote{Sequence}: a data-type used to implement lists 
...
\eqnuote{macros that contain code}, and a
...
\eqnuote{execute} might be used in place of \enquote{expand}
