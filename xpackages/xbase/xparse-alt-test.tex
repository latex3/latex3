...
%  Now it should work
\DeclareDocumentCommand \makebox { d{\NoValue} o d{c} m}
 {
  \IfNoValueTF{#1}
...
\DeclareDocumentCommand \framebox { p{\NoValue} o d{c} m}
 {
  \IfNoValueTF{#1}
...
\DeclareDocumentCommand \foo { m p{{0}{0}} m }
{ \typeout{1:#1}
  \typeout{2:#2}
  \typeout{3:#3}
}
...
\DeclareDocumentCommand \baz { d{?}mmm o mm m }
{ \typeout{1:#1}
  \typeout{2:#2}
  \typeout{3:#3}
  \typeout{4:#4}
