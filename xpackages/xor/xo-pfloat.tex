% Copyright 2000, 2007-2011 Frank Mittelbach
% All rights reserved
%
%
...
column. Similarly the attribute values |page| and |spread| will
...
corresponding floats will be placed such that $f_i$ will be placed
...
contact mean ``traditional'' floats, not footnotes or marginpars.}
...
The \texttt{body-decls} key can hold formatting instructions that
...
\texttt{footnotesetup} template, thereby defining how footnotes are
