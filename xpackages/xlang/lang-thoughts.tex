...
language in specified in every font encoding we need to store such
...
for main text but separate lowercase (only!) ones for hyphenation was
...
is most certainly not correct although there may be some reasons to
