...
\LaTeX3 has been available under the name \package{expl3}. At first, this was
...
that need to be made before \package{expl3} is ready for the \LaTeX~package
author masses.
...
the \package{expl3} programming interface. This programming interface is
...
In preparation for a refactor of the \package{expl3} code, a test suite is
...
\package{siunitx}, \package{fontspec}, and \package{unicode-math}. (Which is
...
to be written almost from scratch, using \package{expl3} and the
\package{xpackages}. A high-level user syntax needs to be designed (based, of
