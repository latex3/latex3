...
\begin{description}
  \item[\pkg{l3kernel}] The core of \LaTeX3, made of of code which
...
\href{https://github.com/latex3/svn-mirror}
{\texttt{https://github.com/latex3/svn-mirror}}. This is kept in
...
site also includes an issue database
(\href{https://github.com/latex3/svn-mirror/issues}
{\texttt{https://github.com/latex3/svn-mirror/issues}}). Given the very
...
the main \LaTeX{} bug database (\href{http://www.latex-project.org/bugs.html}
{\texttt{http://www.latex-project.org/bugs.html}}). Developers and users are
...
\end{verbatim}
This will result in some breaking changes in the \pkg{l3fp} module, but
