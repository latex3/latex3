...
To achieve this
we
% the \LaTeX3 Project Team at the time 
...
the output.
\item
\cs{TRUE}, \cs{FALSE}, \cs{YES}, \cs{NO} insert text strings for standardised comparisons.
\item
...
\item[\texttt{doc} ] This typesets all documentation (by default
  \texttt{.dtx} files), ensuring they compile.
...
\newblock {\em TUGboat}, 18(4):309--311, Dec.\ 1997.
