...
\end{Verbatim}
This test will produce the following in the output as in \LaTeX{} only counters directly ``within'' are reset to zero:
\begin{Verbatim}
==========================================
...
\end{quote}
(To produce an engine-specific \texttt{.tlg} an additional \meta{engine} argument can be given.)
