...
and substraction which is not expandable (therefore \cs{TEST} together
...
tests (e.g., extra packages or classes) from the TDS tree. The later is the default as this is better for most distributions.
%
