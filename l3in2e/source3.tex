...
files on the second run. This involves changing the file l3doc.cfg
...
# First run: 
# Create new standard l3doc.cfg file
...
#
echo "\PassOptionsToClass{$*}{article}" > l3doc.cfg
